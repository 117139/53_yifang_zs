...
(function(b) {
    b.fn.fullpage = function(c) {
        //右侧名称
        var _rightNavName = c.rightNavName;
        function m(a) {
            if (c.autoScrolling) {
                a = window.event || a;
        ...
        b(".section").each(function(a,el) {
            ...
            if (c.navigation) {
                ...
                // console.log(_rightNavName)
                t.find("ul").append('<li data-tooltip="' + a + '"><div class="right_hover"><p>'+_rightNavName[_index]+'</p></div><a href="#' + f + '"><span></span></a></li>')
            }
            if (0 < d) {
                var f = 100 * d,
                h = 100 / d;
